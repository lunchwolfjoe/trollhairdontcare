          ...
          {crews.map((crew) => (
            <Grid item xs={12} md={6} key={crew.id}>
              <Paper sx={{ p: 3 }}>
                ...
                <Typography variant="subtitle2" gutterBottom>
                  Shift: {crew.shiftStartTime} - {crew.shiftEndTime} ({crew.shiftLengthHours} hours)
                </Typography>
                <Typography variant="subtitle2" gutterBottom>
            ...
            <Box sx={{ pt: 2, display: 'flex', flexDirection: 'column', gap: 2 }}>
              ...
              <Box sx={{ display: 'flex', gap: 2 }}>
                <TextField
                  ...
                  onChange={(e) => handleFormChange('shiftStartTime', e.target.value)}
                  fullWidth
                  required
                ...
                <TextField
                  ...
                  onChange={(e) => handleFormChange('shiftEndTime', e.target.value)}
                  fullWidth
                  required
                  InputLabelProps={{ shrink: true }}
                />
              ...
              <TextField
                ...
                type="number"
                value={formData.shiftLengthHours}
